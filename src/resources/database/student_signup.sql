...
CREATE TABLE `course_info` (
  ...
  `course_section_faculty` varchar(45) DEFAULT NULL,
  `course_section_enrollment_code` varchar(45) DEFAULT NULL,
  `course_section_total_students` int DEFAULT NULL,
  PRIMARY KEY (`course_id`,`course_name`,`course_section`)
...
-- Dump completed on 2023-04-05 20:17:32
-- MySQL dump 10.13  Distrib 8.0.32, for Win64 (x86_64)
--
...
CREATE TABLE `course` (
  ...
  `course_section_faculty` varchar(45) DEFAULT NULL,
  `course_section_enrollment_code` varchar(45) DEFAULT NULL,
  `course_section_total_students` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`course_id`,`course_name`,`course_section`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `signupinfo` VALUES ('ikhan201142@bscse.uiu.ac.bd','Israt Jahan Khan','011201142','5555'),('mamin201158@bscse.uiu.ac.bd','Md. Fahim Bin Amin','011201158','1111'),('test@gmail.com','test account','011201159','25');
